...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " لاريكا"
SudosS = {1573309498}
...
type = 'inline',
data = {
{{text = '𝘭𝘢𝘳𝘪𝘤𝘢 𝘵𝘦𝘢𝘮 † . ',url="t.me/LaRiCaTeam"}},
}
}
...
{{text = '- تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "لاريكا"),data="delnamebot"}},
...
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "لاريكا"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "لاريكا"),"اني لقميل "..(redis:get(bot_id..":namebot") or "لاريكا"),(redis:get(bot_id..":namebot") or "لاريكا").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "لاريكا") then
...
{{text = '- 𝖲??𝗎𝖱??𝖾 𝖾𝗂𝗅𝖺𝗇𝖣 .',url="t.me/LaRiCaTeam"}},
}
}
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '𝘭𝘢𝘳𝘪𝘤𝘢 𝘵𝘦𝘢𝘮 † . ',url="https://t.me/LaRiCaTeam"}},
}
}
...
local Text = "*- 𝘞𝘌𝘓𝘤𝘰𝘮𝘦 𝘵𝘰 𝘭𝘢𝘳𝘪𝘤𝘢 𝘵𝘦𝘢𝘮  .*\n"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '-  𝘭𝘢𝘳𝘪𝘤𝘢 𝘵𝘦𝘢𝘮 .',url="https://t.me/LaRiCaTeam"}},
{{text = '- 𝘪𝘯𝘧𝘰 𝘓𝘈𝘙𝘐𝘊𝘈 .',url="https://t.me/filesLaRiCa"}},
{{text = '- 𝘋𝘌𝘷𝘦𝘭𝘰𝘱𝘦𝘳 .',url="https://t.me/sSs_sSs"}},
}
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/LaRiCaTeam&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
----------------------------------------------------------------------------------------------------
if text == 'تفعيل' then
if msg.can_be_deleted_for_all_users == false then
